...
local function buildUI()
    ...
    Part2.Title.Text = "DDS / RDID VEHICLE SPEED SCRIPT V3"
...
local function loadScript()
    ...
    print("Vehicle Boost System with Auto-Save & Straight Boost loaded successfully, you lucky bastard.")
end
...
local function main()
    ...
    if success then
        ...
        createNotification("⚠️ Error", "Failed to load SDK.", 3)
    end
end)
